...
//   // chuyển status gốc trong json sang text hiển thị
...
//   // tính lại trạng thái dựa trên ngày trả và status hiện tại
...
//   // tìm thời điểm nhận sớm nhất và trả muộn nhất
...
//   // 1) nếu đã qua ngày trả → Hoàn thành
//   if (now.getTime() > latestEnd.getTime()) {
//     return 'Hoàn thành';
//   }

//   // 2) nếu đang nằm giữa ngày nhận và ngày trả → Đang thuê
//   if (now.getTime() >= earliestStart.getTime() &&
//       now.getTime() <= latestEnd.getTime()) {
//     return 'Đang thuê';
//   }

//   // 3) còn lại: đơn ở tương lai → dùng trạng thái gốc (Đã xác nhận / Chờ thanh toán...)
//   return this.mapStatus(order.tinhTrangDon);
// }
...
//   rentAgain(order: AccountOrderCard): void {
